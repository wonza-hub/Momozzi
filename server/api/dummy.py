...
def dummy_user_add():
    user_data = [
        {"first_name": "홍", "last_name": "길동", "email": "gildong@a.com", "password": "1234", "age": 20},
        {"first_name": "김", "last_name": "철수", "email": "kimm@a.com", "password": "1234", "age": 22},
        {"first_name": "허", "last_name": "원일", "email": "heo@a.com", "password": "1234", "age": 25},
        {"first_name": "박", "last_name": "장고", "email": "django@a.com", "password": "1234", "age": 30},
    ]
    sql = "INSERT INTO api_user (first_name, last_name, email, password, age) VALUES (%s, %s, %s, %s, %s)"
    with connection.cursor() as cursor:
        for user in user_data:
            cursor.execute(sql, [user['first_name'], user['last_name'], user['email'], user['password'], user['age']])
...
def dummy_recipe_add():
    ...
    sql = "INSERT INTO api_recipe (cook_time, description, process, cuisine_name) VALUES (%s, %s, %s, %s)"
    with connection.cursor() as cursor:
        for recipe in recipe_data:
            cursor.execute(sql, [recipe['cook_time'], recipe['description'], recipe['process'], recipe['cuisine_name']])
    return
...
def dummy_review_add():
    review_data = [
        {"content": "맛있는 라면이에요!", "user_id": 1, "recipe_id": 1},
        {"content": "엄마가 해주시던 김치찌개 맛이 나네요..ㅠㅠ", "user_id": 2, "recipe_id": 2},
        {"content": "아이들이 너무 좋아했어요!", "user_id": 3, "recipe_id": 3},
        {"content": "조리가 너무 간단해서 좋았어요!", "user_id": 4, "recipe_id": 4},
    ]
    sql = "INSERT INTO api_review (content, user_id, recipe_id) VALUES (%s, %s, %s)"
    with connection.cursor() as cursor:
        for review in review_data:
            cursor.execute(sql, [review['content'], review['user_id'], review['recipe_id']])
    return
...
def dummy_refrigerator_add():
    refrigerator_data = [
        ...
        {"user_id": 2, "created_at": "2021-01-01 00:00:00", "capacity": 300},
        {"user_id": 3, "created_at": "2021-01-01 00:00:00", "capacity": 300},
        {"user_id": 4, "created_at": "2021-01-01 00:00:00", "capacity": 300},
    ]
